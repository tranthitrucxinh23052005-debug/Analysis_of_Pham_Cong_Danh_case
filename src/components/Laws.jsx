    ...
    <section id="needlaws" className="py-20 px-8 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <motion.h2 
          ...
          className="text-3xl md:text-4xl font-bold text-[#3E2723] mb-12 text-center drop-shadow-[0_0_5px_#D4A373]"
        >
        ...
        <div className="flex flex-nowrap overflow-x-auto gap-6 pb-8 snap-x no-scrollbar">
          {laws.map((law, index) => (
            <motion.div
              ...
              className={`min-w-[280px] md:min-w-[320px] ${law.color} backdrop-blur-md p-8 rounded-3xl border-2 border-[#FAF4EB]/50 shadow-lg snap-center`}
            >
              <div className="text-sm font-black text-[#8D6E63] uppercase tracking-widest mb-2">{law.article}</div>
              <h3 className="text-xl font-bold text-[#3E2723] mb-4">{law.title}</h3>
        ...
        <p className="text-center text-[#8D6E63] text-xs mt-4 animate-pulse">
